 ...
 * @author rubens
 */
public class ManagerMoreDPS extends ManagerAbstraction {

    private int _cenX, _cenY;

    public ManagerMoreDPS(int _playerID, int numUnits) {
    ...
    private long getIDUnitMoreDPS(GameState state) {
